...
if __name__ == "__main__":
    ...
    # Nombre del robot
    main.setRobotName(config.get('robot_name', 'Charro Negro'))
    ...
    _breathing_wav = _idle_cfg.get('sound_wavs', ["charro_negro/audios/auxiliar_sound.wav"])
    ...
    main.setIdleLoopBehaviour(sound_loop)
